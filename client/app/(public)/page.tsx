...
const Page = () => {
  ...
  useEffect(() => {
    if (clickCount === 3) {
      ...
      window.location.href = "/login?secret=true";
    }
              ...
              ${isDark
                  ...
                  >
                    <CardContent className="p-0 flex flex-col items-center justify-center gap-1">
                      ...
                      <p className={`${theme.text} text-[16px] font-medium text-center w-full`}>
            ...
            >
              ...
              >
                <CardContent className="p-0 flex flex-col items-center justify-center gap-1">
                  ...
                  <p className={`${theme.text} text-[16px] font-medium`}>
              ...
              {about?.journey && (
                ...
                >
                  <CardContent className="p-0">
                    <h3 className={`font-semibold mb-2 flex items-center gap-2 text-[15px] md:text-[17px] ${theme.text}`}>
                      <Briefcase size={18} style={{ color: theme.primary }} />
                      My Journey
                    </h3>
                    <p className={`text-[14px] md:text-[16px] font-medium ${theme.mutedText}`}>
                      {about?.journey}
                    </p>
                  </CardContent>
                </Card>
                  ...
                  >
                    {skillsFrontend.map((skill: any) => (
                      <motion.div key={skill._id || skill.skillName} variants={itemVars}>
                        <Card
                          className={`transition-all duration-300 cursor-pointer hover:-translate-y-1 h-full
                      ${isDark
                              ? "bg-[#020617]/60 backdrop-blur-xl border border-[#1E293B] hover:border-[#145EFB]/50 hover:shadow-[0_0_18px_rgba(20,94,251,0.35)]"
                              : "bg-white/60 backdrop-blur-xl border border-transparent hover:border-[#145EFB] hover:shadow-lg"
                            }`}
