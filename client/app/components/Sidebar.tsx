...
import { Menu, X, BookOpen, Briefcase, Folder, Grid, User, GraduationCap, MessageSquare } from "lucide-react";
...
const Sidebar = ({ children }: { children: React.ReactNode }) => {
    ...
    const menuItems = [
        ...
        { id: 6, label: "Contact", path: "/admin/contact", icon: MessageSquare },
    ];
